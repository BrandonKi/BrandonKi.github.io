...
For a more readable writeup take a look at my [reddit post](https://www.reddit.com/r/factorio/comments/1jzlin2/neural_network_in_factorio_handwritten_digit/).
...
![XOR Neural Network Diagram](xor_nn_dark.png)
...
![ReLU Graph](relu_graph.png)

#### Sigmoid

For the output layer it's common to use the sigmoid activation function for [binary classification](https://en.wikipedia.org/wiki/Binary_classification) problems, which XOR is. Sigmoid's output is a value between $0$ and $1$, and can be interpreted as a probability. It's often defined by the following:
...
![multicycle 3x3 matmul](multicycle_3x3_matmul.png)
